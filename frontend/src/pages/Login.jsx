...
const Login = () => {
  ...
  return (
    <section className="w-screen bg-green-400 h-screen font-Manrope flex">
      <aside className="w-7/12 h-full greengradient flex justify-start items-center flex-col max-xl:justify-center relative">
      ...
      <main className="w-5/12 h-full bg-[#121313] flex flex-col items-center justify-start relative">
        <header className="w-full flex items-center justify-around flex-col">
          <h1 className="flex w-full justify-start items-center p-8 pl-36 max-xl:pl-12">
            <p className="greengradient w-10 h-10 rounded-full"></p>
